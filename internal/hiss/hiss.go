...
// ErrScanTruncated is wrapped by callers that refuse to certify a capped report.
var ErrScanTruncated = errors.New("hiss: scan truncated at the infraction cap; the report is a lower bound")
...
type ScanReport struct {
	...
	// Truncated is true when the infraction cap was reached: files after the cutoff
	// were not scanned and TotalInfractions is a lower bound.
