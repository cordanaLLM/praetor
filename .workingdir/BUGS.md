...
| `BUG-005` | [F13] Scaffolded Makefile &#39;verify-all&#39; target is an echo no-op | p1 | resolved | internal/adopt/adopt.go:1039 | Exact historical echo-only Makefiles with and without leading newline now migrate. Actual legacy local file retained as fixture: red then green, real MCP replacement and repeat stability, full verify-all source0fbe86ef. | <!-- praetor-bug:v1 eyJjb250ZXh0IjoiIiwiY3JlYXRlZF9hdCI6IjAwMDEtMDEtMDFUMDA6MDA6MDBaIiwicmVzb2x2ZWRfYXQiOiIyMDI2LTA5LTEyVDIxOjQ2OjIxLjU0ODMwNzk5OVoifQ== -->
...
| `BUG-042` | [F635] Scaffolded Makefile&#39;s `verify-all` is `@echo` — the gate every other emitted artifact points at does nothing | p1 | resolved | internal/adopt/adopt.go:1039 | Duplicate no-op scaffold finding fixed with BUG-005; real historical rendered fixture and MCP replay prove native command replacement and failure propagation. Full verify-all source0fbe86ef passed. | <!-- praetor-bug:v1 eyJjb250ZXh0IjoiIiwiY3JlYXRlZF9hdCI6IjAwMDEtMDEtMDFUMDA6MDA6MDBaIiwicmVzb2x2ZWRfYXQiOiIyMDI2LTA5LTEyVDIxOjQ2OjIxLjU2MTc2MDI4MVoifQ== -->
...
| `BUG-190` | [F389] State audit and sync swallow every ledger read error via blank identifiers, so an unreadable BUGS.md audits as clean | p2 | resolved | internal/state/audit.go:49 | F389 verified fixed: audit, sync and Hindsight propagate ledger read/parse errors; malformed P0 and symlink-loop CLI fixtures fail with unchanged BUGS and STATE; race tests pass. Git status errors and task/question mutation semantics remain separate findings. Evidence: ledger-repair-20260912. | <!-- praetor-bug:v1 eyJjb250ZXh0IjoiIiwiY3JlYXRlZF9hdCI6IjAwMDEtMDEtMDFUMDA6MDA6MDBaIiwicmVzb2x2ZWRfYXQiOiIyMDI2LTA5LTEyVDE5OjQxOjUwLjIwMDA4MDU1NloifQ== -->
...
| `BUG-713` | [F5] Scaffolded lefthook hooks can never fail (&#39;&#124;&#124; true&#39; precedence) and block_evasion.py runs with no arguments | p1 | open | internal/adopt/adopt.go:549 |  | <!-- praetor-bug:v1  -->
| `BUG-714` | [F392] A &#39;&#124;&#39; in a bug title silently deletes the bug from BUGS.md and makes the next bug reuse its ID | p1 | resolved | internal/state/bugs.go:108 | F392 verified fixed: lossless versioned rows, strict full-ledger parsing, stable IDs and preserved untouched bytes; positive, malformed, boundary, contention and fresh CLI regression checks pass. Evidence: ledger-repair-20260912. | <!-- praetor-bug:v1  -->
| `BUG-715` | [F485] gc follows symlinked .standards/ephemeral&#124;worktrees&#124;tmp and bin dirs and RemoveAll&#39;s the link target&#39;s contents | p1 | open | internal/gc/gc.go:194 |  | <!-- praetor-bug:v1  -->
| `BUG-716` | [F634] Every governance gate in the scaffolded lefthook.yml ends in `&#124;&#124; true`, so adopted repos&#39; hooks can never fail | p1 | open | internal/adopt/adopt.go:551 |  | <!-- praetor-bug:v1  -->
| `BUG-717` | Selected empty framework still reports full replacement availability because needs reports ignore its index | p2 | resolved | cmd/standards-mcp/server.go:623 | Resolved in5fc1c21ad3ec5ab3aae4304f2c198be0f67ce6f8: CLI/MCP reports and fleet reconciliation use exact selected source index. Empty and header-only packages report gaps; source declarations remain unverified candidates. Three-package race/lint/gosec and fresh35-check MCP plus parity passed; integrated full make verify-all passed. Migration/epic generator bypass is separately tracked and not covered by this closure. | <!-- praetor-bug:v1  -->
| `BUG-718` | Adoption conflates governance archetype with runtime and emits Go or Meson verification for unrelated build systems | p2 | resolved | internal/adopt/harness.go:archetypeCommands | One bounded metadata plan now feeds Makefile and AGENTS; full make verify-all passed on source0fbe86ef. Pinned Jellysin MCP governance replay retains Node/dotnet/Python plan and explicit unavailable helper build contract. | <!-- praetor-bug:v1  -->
| `BUG-719` | Unsupported source extensions disappear from HISS reports with zero debt and no recorded analysis coverage | p2 | resolved | internal/hiss/hiss.go:visitFile | Resolved by4168620209f31473910d53e457e0794ca065f848: bounded file-read and unscanned-extension evidence, unknown historical coverage, CLI/MCP scope diagnostics. Full make verify-all passed on source6605789e4f3c0048c11a5ce8a3c0b84f6d5cb07c46fb00940382f173a550e78b; CSharp negative, empty/mixed,32-extension/byte boundaries, ignored/oversize/symlink/truncation and adapter regressions retained in repo-interconnect-20260912. No CSharp analyzer claimed. | <!-- praetor-bug:v1  -->
| `BUG-720` | Migration and epic generators bypass selected framework coverage and propose catalog imports with a default release version | p2 | resolved | internal/needs/migrate.go:PlanMigration | Migration plans and epics now share selected framework evidence; missing selections fail and invented releases are removed. Unverified application rejects before commands or writes. Integrated full make verify-all passed at 7e4aaa7; executable version/API admission remains an explicit open task. | <!-- praetor-bug:v1  -->
