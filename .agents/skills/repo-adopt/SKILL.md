...
Adopt any codebase—greenfield, partially setup, or legacy brownfield—into the `cordanaLLM/praetor` governance lattice in a single deterministic command.

## 4-Step Adoption Workflow

1. **Dry-Run State Assessment**:
   - Preview planned scaffolding actions and archetype classification:
     ```bash
